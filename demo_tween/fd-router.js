/*!
 * fd-router v1.0.0
 * http://www.feeldesignstudio.com/2016/01/fd-router-a-simple-javascript-router-for-spa/
 * https://github.com/jnoodle/fd-router
 */
 //v1.0.1
// modified by wanghsinche@hotmail.com
(function (global, factory) {
    ...
    else if (typeof nie === 'object' && typeof nie.define === 'function') {
        //nie define
        nie.define('fdRouter',function(){
            return factory(global);
        });
    } 
    ...
    var Router = {
        ...
        listen: function () {
            var self = this;
            var current, matchRoutes, previousMatchRoutes, previous;
            var fn = function () {
                if (current !== self.getCurrentFragment()) {
                    ...
                    if (previous) {
                        previousMatchRoutes = self.match(previous);
